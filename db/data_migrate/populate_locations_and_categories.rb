class PopulateLocationsAndCategories
  ...
  def self.run!
    ...
    story_categories.each do |story_cat|
      ...
      StoryCategory.create!(code: story_cat.code_key, name: story_cat.code_value) unless StoryCategory.exists?(code: story_cat.code_key)
    end
    ...
    place_categories.each do |place_cat|
      ...
      PlaceCategory.create!(code: place_cat.code_key, name: place_cat.code_value) unless PlaceCategory.exists?(code: place_cat.code_key)
    end
  end
