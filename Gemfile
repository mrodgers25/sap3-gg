...
gem 'bootstrap-sass', '~> 3.4.1' #changed to 3.3.7 to go with Rails 4.2.0 #, '~> 3.2.0' had to hard code version number to get it to work with old versions of Rails and Ruby
