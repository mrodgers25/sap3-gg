...
class MediaInfosControllerTest < ActionController::TestCase
  ...
  test 'should create media_info' do
    assert_difference('MediaInfo.count') do
      post :create, params: { media_info: { media_desc: @media_info.media_desc, media_type: @media_info.media_type,
                                            url_id: @media_info.url_id } }
    end
  ...
  test 'should show media_info' do
    get :show, params: { id: @media_info }
    assert_response :success
  end

  test 'should get edit' do
    get :edit, params: { id: @media_info }
    assert_response :success
  end

  test 'should update media_info' do
    patch :update,
          params: { id: @media_info,
                    media_info: { media_desc: @media_info.media_desc, media_type: @media_info.media_type,
                                  url_id: @media_info.url_id } }
    assert_redirected_to media_info_path(assigns(:media_info))
  end
  ...
  test 'should destroy media_info' do
    assert_difference('MediaInfo.count', -1) do
      delete :destroy, params: { id: @media_info }
    end
